  ...
  >
    ...
    >
      ...
      <n-grid :cols="isMobile ? 1 : 2" :x-gap="isMobile ? 0 : 20">
        ...
        <n-gi>
          <n-form-item label="修附件库存" path="physical_stock">
            <n-input-number
      ...
      <n-grid :cols="isMobile ? 1 : 2" :x-gap="isMobile ? 0 : 20">
        ...
        <n-gi>
          <n-form-item label="保管人">
            <n-input v-model:value="formData.custodian" placeholder="保管人" clearable :maxlength="100" show-count />
          </n-form-item>
        </n-gi>
      </n-grid>
      ...
      <n-grid :cols="isMobile ? 1 : 2" :x-gap="isMobile ? 0 : 20">
        <n-gi>
          <n-form-item label="图号">
            <n-input v-model:value="formData.drawing_no" placeholder="图号" clearable :maxlength="100" show-count />
          </n-form-item>
        </n-gi>
        <n-gi>
          <n-form-item label="处置方式">
            <n-input v-model:value="formData.disposal_method" placeholder="处置方式" clearable :maxlength="200" show-count />
          </n-form-item>
        </n-gi>
      </n-grid>
      <n-form-item label="来源说明">
        <n-input v-model:value="formData.source_description" type="textarea" :rows="2" placeholder="来源说明" clearable :maxlength="500" show-count />
      </n-form-item>
      <n-form-item label="技术鉴定">
        <n-input v-model:value="formData.technical_appraisal" type="textarea" :rows="2" placeholder="技术鉴定" clearable :maxlength="500" show-count />
      </n-form-item>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    window.$message?.success(isEditMode.value ? '机械设备更新成功' : '机械设备创建成功')
